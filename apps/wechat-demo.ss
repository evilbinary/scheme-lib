...
(define (wechat-app)
  ...
  (let ((main (view (* 1.0 width) %match-parent))
	...
	(chat-img (image 32.0 32.0 "chat.png"))
	...
	(face (image 22.0 22.0 "smail.png"))
	(file (image 22.0 22.0 "file.png"))
	(shot (image 22.0 22.0 "shot.png"))
	(history (image 20.0 22.0 "history.png"))
    ...
    (widget-set-attrs chat-input 'color #x000000)
    ...
    (widget-add-draw
	 ...
	 (draw-text (+ x 20.0) (+ y 18.0)  "Lisp兴趣项目测试组" #x00000)
