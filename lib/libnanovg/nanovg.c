...
void printNVGcolor(NVGcolor color){
...
void printNVGpaint(NVGpaint paint){
	...
	printf("feather=%f\n",paint.feather);
	printf("innerColor ");
	printNVGcolor(paint.innerColor);
	printf("outerColor ");
	printNVGcolor(paint.outerColor);
	printf("image=%f\n",paint.image);
	printf("\n");
...
void nvgFillPaint(NVGcontext* ctx, NVGpaint paint)
{
	...
	// paint.extent[0]=100.0;
	// paint.extent[1]=75.0;

	// paint.radius=6.0;
	// paint.feather=10.000000;

	// paint.innerColor.r=0.0;
	// // paint.innerColor.a=0.501961;

	// paint.outerColor.b=0.0;
