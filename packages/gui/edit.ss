...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(library (gui edit)
  (export edit-set-foreground edit-set-background
   edit-set-font-size edit-set-font-name edit-set-font
   edit-get-height edit-set-highlight edit-get-highlight
   edit-update-highlight edit-char-event edit-get-text
   edit-set-font edit-mouse-event edit-key-event
   edit-set-scroll edit-mouse-motion-event
   edit-set-select-color edit-set-cursor-color
   edit-set-font-line-height edit-set-show-no
   edit-set-lineno-color edit-get-selection edit-set-selection
   edit-get-line-count edit-get-row-count edit-get-cursor-x
   edit-get-cursor-y edit-measure-text edit-get-font
  ...
  (def-function
    ...
    "edit_get_select_row_start"
    (void*)
    int)
  (def-function
    edit-get-selection-row-end
    "edit_get_select_row_end"
    (void*)
    int)
  (def-function
    edit-get-selection-col-start
    "edit_get_select_col_start"
    (void*)
    int)
  (def-function
    edit-get-selection-col-end
    "edit_get_select_col_end"
    (void*)
    int)
  (def-function
    edit-get-line-count
  ...
  (def-function
    new-edit
    "new_edit"
    (int void* float float float float float float)
    void*)
  (def-function
    edit-add-text
    "add_edit_text"
  ...
  (def-function
    ...
    "edit_mouse_motion_event"
    (void* float float)
    void)
  (def-function
    edit-set-select-color
    "edit_set_select_color"
    (void* int)
    void)
  (def-function
  ...
  (define (edit-new font font-size w h)
    (let ([ed (new-edit font-program font (* my-ratio font-size)
                my-ratio w h my-width my-height)])
      (hashtable-set! all-edit-cache ed ed)
      ed))
  (define (draw-edit edit x y) (render-edit edit x y))
  ...
  (graphic-add-resize-event
    (lambda (g width height)
      (let ([eds (vector->list
                   (hashtable-values all-edit-cache))])
        (let loop ([ed eds])
          (if (pair? ed)
              (begin
