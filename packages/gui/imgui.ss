...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(library (gui imgui)
  (export imgui-init imgui-exit imgui-test imgui-touch-event
   imgui-key-event imgui-motion-event imgui-mouse-event
   imgui-resize imgui-scale imgui-render-start imgui-render-end
   imgui-disable-default-color imgui-get-default-color
   imgui-make-vec2 imgui-make-text-edit-callback
   imgui-load-texture imgui-pvec2 imgui-uvec2 imgui-load-style
   imgui-save-style imgui-reset-style imgui-get-io imgui-text
   imgui-new-frame imgui-render imgui-color-edit3
   imgui-set-next-window-size imgui-set-next-window-pos
   imgui-begin imgui-end imgui-button imgui-small-button
   imgui-input-text imgui-input-text-multiline imgui-checkbox
   imgui-get-text-line-height imgui-get-mouse-cursor
   imgui-is-mouse-clicked imgui-is-mouse-down imgui-image
   imgui-tree-node imgui-tree-pop imgui-set-cond-always
   imgui-set-cond-once imgui-set-cond-first-use-ever
   imgui-set-cond-appearing << >> imgui-begin-group
   imgui-end-group imgui-same-line imgui-separator)
  ...
  (define-imgui
    boolean
    imgui-input-text
    (string string int int void* void*))
  (define-imgui
    boolean
    imgui-input-text-multiline
    (string string int int void* void* void*))
  ...
  (define imgui-resize
    (foreign-procedure "imgui_resize" (int int) void))
  (define imgui-render-start
    (foreign-procedure "imgui_render_start" () void))
  (define imgui-make-vec2
    (foreign-procedure "imgui_make_vec2" (float float) void*))
  (define imgui-render-end
    (foreign-procedure "imgui_render_end" () void))
  (define imgui-motion-event
    (foreign-procedure "imgui_motion_event" (int int) void))
  (define imgui-mouse-event
    (foreign-procedure "imgui_mouse_event" (int int) void))
  (define imgui-key-event
    (foreign-procedure "imgui_key_event"
      (int int int string)
      void))
  (define imgui-touch-event
    (foreign-procedure "imgui_touch_event" (int int int) void))
  ...
  (define imgui-pvec2
    (foreign-procedure "imgui_pvec2" (float float) void*))
  (define imgui-uvec2
    (foreign-procedure "imgui_uvec2" (void*) void))
  (define imgui-load-style
    (foreign-procedure "imgui_load_style" (string) void))
  (define imgui-save-style
    (foreign-procedure "imgui_save_style" (string) void))
  (define imgui-reset-style
    (foreign-procedure "imgui_reset_style" (int) void)))
