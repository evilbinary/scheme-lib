...
(library (surfage s25 multi-dimensional-arrays all)
  (export
    array:make
    array:array?
    array:vector
  ...
  (SRFI-23-error->R6RS "(library (surfage s25 multi-dimensional-arrays))"
   (include/resolve ("surfage" "s25") "ix-ctor.scm")
   (include/resolve ("surfage" "s25") "op-ctor.scm")
   (include/resolve ("surfage" "s25") "array.scm"))
)
